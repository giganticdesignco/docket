...
export type Database = {
  public: {
    Tables: {
      ...
      projects: Table<Project, Pick<Project, 'client_id' | 'name'> & Partial<Project>>
      tasks: Table<Task, Pick<Task, 'name'> & Partial<Task>>
      project_tasks: Table<ProjectTask, Pick<ProjectTask, 'project_id' | 'task_id'> & Partial<ProjectTask>>
    }
